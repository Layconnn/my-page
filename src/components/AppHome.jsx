                    ...
                    <div className="app_home_main_contents_inputs_inner">
                      ...
                      <div className="video_url">
                        ...
                        <span className="btn_copy">
                          <img src='./copy_icon.svg' alt="copy_icon" />
                          <span>Copy URL</span>
                        </span>
                      </div>
                    </div>
      ...
      <div className="share_video_sec">
        <div className="share_video_inner">
          ...
          <div className="action_btns">
            <button>
              <img src='./fb_icon.svg' alt="social_icon" />

              <span>Facebook</span>
            </button>
            <button>
              <img src='./whatsapp_icon.svg' alt="social_icon" />
              <span>WhatsApp</span>
            </button>
            <button>
              <img src='./telegram_icon.svg' alt="social_icon" />
